export default function InfoCard({ title, icon }) {
  return (
    <div className="flex flex-col justify-center items-center gap-5 rounded-3xl bg-gradient-to-br from-green-500/70 to-green-600/80 backdrop-blur-2xl p-8 w-56 mx-auto">
